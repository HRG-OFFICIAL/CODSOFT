let display = document.querySelector('.top-panel');
let historyContainer = document.querySelector('.right-container-list');
...
document.querySelector('.right-container-clear').addEventListener('click', clearHistory);
